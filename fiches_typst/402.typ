...
#grid(
  ...
  [
    #box(
      ...
      stroke: 1.2pt + brand,
      [
        #text(size: 0.85em, weight: "bold", fill: brand)[FICHE 36 <ind-36>]
      ]
    )
  ]
)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure le niveau de sensibilité naturelle du terrain à laisser passer l'eau via les aquifères. L'indicateur utilise la base \"BDLISA\-NC\" de la DIMENC décrivant les limites et les caractéristiques hydrogéologiques des formations aquifères.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur la sensibilité naturelle des aquifères.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer la vulnérabilité de la ressource en eau aux infiltrations et contaminations.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : BDLISA\-NC \- Vulnérabilité intrinsèque des eaux souterraines \(gdb\)],
 0.7em,
    text(size: 0.75em)[Base de Données des Limites Aquifères de Nouvelle\-Calédonie pour la cartographie et la caractérisation hydrogéologiques des formations à l’échelle du territoire.  Cette donnée traduit la vulnérabilité, elle intègre différentes pressions et caractéristiques physiques et peut servir de synthèse pour évaluer le superficiel et le souterrain.],
 0.5em,
