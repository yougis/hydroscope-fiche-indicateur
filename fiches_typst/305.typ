...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Dénombre les ouvrages de franchissement \(ponts, radiers\) situés sur l'aire d'alimentation, chaque pont, buse ou gué est un point où une pollution routière \(hydrocarbures, transport de matières dangereuses\) peut entrer directement dans le cours d'eau en amont d'un captage. La donnée croise le \"Réseau routier\" de la DITTT et les inventaires de la DAVAR pour identifier les points de contact avec le réseau hydrographique.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur la présence d’ouvrages de franchissement afin de caractériser les points de contact avec le réseau hydrographique.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer les points de vulnérabilité pouvant impacter la ressource en eau.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
        text(size: 0.75em, weight: "bold")[Modalités de traitement],
        text(size: 0.71em)[Comptage des intersections entre les ouvrages linéaires \(routes, pistes\) et le réseau hydrographique.],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
...
#block(breakable: true,
 ...
 0.5em,
 0.7em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Franchissement du réseau hydrographique des BVAEP \(nom à vérifier\)],
 0.7em,
    text(size: 0.75em)[Base de données de la DAVAR identifiant les franchissements sur le réseau hydrographique],
 0.5em,
 ...
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Contraintes :] Donnée robuste mais reposant sur un modèle, nécessitant une bonne compréhension.],
 0.5em,
 0.7em,
  )
)
