...
#v(0.3em)
#text(size: 0.85em, fill: rgb("#666"))[Fiche n°22]
#v(0.5em)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Comparer les bassins versants selon leur instabilité afin d’identifier les zones à risque pour la ressource.],
      ),
      stack(dir: ttb, spacing: 0.1em,
...
#box(
  ...
  stack(dir: ttb, spacing: 0.3em,
    ...
    stack(dir: ttb, spacing: 0.1em,
      text(size: 0.75em, weight: "bold")[Incohérence (R5)],
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    text(size: 0.75em)[#link("https://dtsi-sgt.maps.arcgis.com/home/item.html?id=c472c49f798046b9b2c716c83523c324")[🔗 Ressource]],
    text(size: 0.71em, style: "italic")[Aléa (très faible, faible, modéré, élevé)],
  )
)
#v(0.5em)
#pagebreak()
