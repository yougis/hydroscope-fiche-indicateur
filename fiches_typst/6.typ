...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Estimation du nombre d'habitants rattachés à l'unité de distribution \(UD\) alimentés par la ressource. Le calcul s'appuie sur les fichiers administratifs internes de suivi des abonnés issus de la base de données de l'unité de distribution de la DASS.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur le nombre d’habitants dépendants du captage afin de caractériser l’importance des usages associés.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer l’importance stratégique du captage pour l’alimentation en eau, une population élevée augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
        text(size: 0.75em, weight: "bold")[Modalités de traitement],
        text(size: 0.71em)[Affectation par unité de distribution puis agrégation au captage.],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[Valeur de classe appliquée arbitrairement #h(0.2em) #text(fill: rgb("#555555"), size: 0.95em)[↔]],
      ),
    )
  ),
