...
#grid(
  ...
  [
    #box(
      ...
      stroke: 1.2pt + brand,
      [
        #text(size: 0.85em, weight: "bold", fill: brand)[FICHE 5 <ind-5>]
      ]
    )
  ]
)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Établit la longueur approximative des réseaux d'adduction et de distribution de l'unité de distribution \(UD\) associée à la ressource. Ces données proviennent des registres de l'unité de distribution gérés par la DASS, initialement destinés à une vocation administrative interne décrivant les infrastructures linéaires.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur l’étendue des réseaux d’adduction et de distribution dépendants du captage afin de caractériser l’importance des infrastructures alimentées.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer l’importance stratégique des infrastructures dépendantes de la ressource en eau, un réseau étendu augmentant la criticité en cas de défaillance.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
