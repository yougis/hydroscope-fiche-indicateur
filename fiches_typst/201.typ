...
#v(0.3em)
#text(size: 0.85em, fill: rgb("#666"))[Fiche n°20]
#v(0.5em)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Comparer les bassins versants selon leur sensibilité à l’érosion afin d’identifier les ressources exposées à des dégradations du milieu.],
      ),
      stack(dir: ttb, spacing: 0.1em,
