...
#v(0.3em)
#text(size: 0.85em, fill: rgb("#666"))[Fiche n°7]
#v(0.5em)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Comparer les captages selon leur niveau de conformité réglementaire afin d’identifier les situations à risque.],
      ),
      stack(dir: ttb, spacing: 0.1em,
        text(size: 0.75em, weight: "bold")[Normalisation],
        text(size: 0.71em)[Binaire (1 & 3)],
      ),
      stack(dir: ttb, spacing: 0.1em,
