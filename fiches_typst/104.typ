...
#v(0.3em)
#text(size: 0.85em, fill: rgb("#666"))[Fiche n°15]
#v(0.5em)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Identifier la présence de forêt sèche, écosystème endémique parmi les plus menacés de Nouvelle-Calédonie.],
      ),
      stack(dir: ttb, spacing: 0.1em,
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    text(size: 0.75em)[#link("https://georep-dtsi-sgt.opendata.arcgis.com/maps/b9304b72009f45e6aa4fc2fab702e98b")[🔗 Ressource]],
    text(size: 0.71em, style: "italic")[Cartographie partielle selon les provinces.],
  )
)
#v(0.5em)
#pagebreak()
