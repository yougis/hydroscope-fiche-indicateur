...
#grid(
  ...
  box(
    ...
    radius: 999pt,
    inset: (x: 12pt, y: 8pt),
    text(size: 0.9em, weight: "bold", fill: white)[Fiche n°101]
  ),
)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Caractériser le niveau de protection réglementaire du milieu naturel autour des ressources en eau.],
      ),
      stack(dir: ttb, spacing: 0.1em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Présence en zone protégée = criticité faible bien que  enjeu fort],
      ),
    )
  ),
  box(
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.95em, weight: "bold")[Aires protégées de la Province Sud],
    ...
    text(size: 0.85em, style: "italic")[Aires terrestres protégées à compiler depuis les sources des 3 provinces],
  )
)
#v(0.5em)
#box(
  ...
  inset: 10pt,
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.95em, weight: "bold")[Aires protégées de la Province Nord],
...
#box(
  ...
  inset: 10pt,
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.95em, weight: "bold")[Aires protégées de la Province des Iles],
