...
#stack(dir: ltr, spacing: 0.6em,
  ...
  box(fill: rgb("#f1f5f9"), stroke: 0.5pt + rgb("#cbd5e1"),
    inset: (x: 6pt, y: 4pt), radius: 3pt,
    text(size: 0.75em, fill: rgb("#475569"))[État écologique et rôle protecteur]
  ),
)
#v(0.6em)
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Superficie des intersections avec des zones de couverture forestière non perturbée et dégradée],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer l'état de la couverture forestière, protectrice de la ressource en eau.],
    0.5em,
...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Utilisation de la donnée sans les classes des dynamiques],
    0.5em,
