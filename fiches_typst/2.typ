...
#v(0.3em)
#text(size: 0.85em, fill: rgb("#666"))[Fiche n°2]
#v(0.5em)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Comparer l’importance des infrastructures dépendantes de chaque captage afin d’identifier ceux dont la défaillance aurait le plus d’impact.],
      ),
      stack(dir: ttb, spacing: 0.1em,
