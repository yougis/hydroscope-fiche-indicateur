...
#stack(dir: ltr, spacing: 0.6em,
  ...
  box(
    ...
    inset: (x: 6pt, y: 4pt),
    radius: 3pt,
    text(size: 0.75em, weight: "medium", fill: rgb("#475569"))[État sanitaire et suivi de la qualité]
  )
)
#v(0.6em)
#box(
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Base de données ATYA],
 0.7em,
    text(size: 0.75em)[Données DASS/ATYA diffusion interne – contacter DASS],
 0.5em,
