...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Une Installation Classée pour la Protection de l’Environnement \(ICPE\) est une activité fixe à caractère industriel ou agricole susceptible de provoquer des pollutions, des nuisances ou des risques, notamment pour la sécurité, la santé des riverains et\/ou l’environnement.],
    0.5em,
