...
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Nombre de bâtiments présents.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Comparer les bassins versants selon leur niveau d’artificialisation afin d’identifier les pressions liées aux activités humaines.],
    0.5em,
...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Couche des  localités et zones bâties : Villes, lieux\-dits, tribus – échelle 1\/50 000 – mise à jour 2022. possibilité d’obtenir la surface du bâti associé et d’un nombre d’habitant \(approximatif\)],
    0.5em,
    ...
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Données brutes de la BDTOPO. Superficie par typologie de bâti. Disponible de la données sur commande.],
    0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Origine :] DITTT],
    0.5em,
