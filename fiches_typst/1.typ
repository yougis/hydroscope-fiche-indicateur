...
#v(0.3em)
#text(size: 0.85em, fill: rgb("#666"))[Fiche n°1]
#v(0.5em)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Comparer la capacité des captages à fournir de l’eau en période contrainte (sécheresse, inondation, glissement de terrain) afin d’identifier les ressources les plus robustes ou les plus limitées.],
      ),
      stack(dir: ttb, spacing: 0.1em,
        text(size: 0.75em, weight: "bold")[Normalisation],
        text(size: 0.71em)[Classes 3 niveaux (quantiles ou seuils métier)],
      ),
      stack(dir: ttb, spacing: 0.1em,
...
#box(
  ...
  stack(dir: ttb, spacing: 0.3em,
    ...
    stack(dir: ttb, spacing: 0.1em,
      text(size: 0.75em, weight: "bold")[Redondance (R1)],
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Hydrométrie – Stations DAVAR / Bassins versants aux limnimètres],
    ...
    text(size: 0.75em)[#link("https://georep-dtsi-sgt.opendata.arcgis.com/maps/01ed729cd25a4927823a228a9770b2b3")[🔗 Ressource]],
    text(size: 0.71em, style: "italic")[Métadonnées stations de jaugeage et limnimètres DAVAR],
  )
)
#v(0.5em)
#pagebreak()
