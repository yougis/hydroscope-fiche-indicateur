...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure la quantité de pluie moyenne reçue sur l'aire d'alimentation de la ressource. Cet indicateur exploite les données des stations de Météo France NC fournissant les mesures de précipitations moyennes sur le territoire.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur les apports en eau liés aux précipitations.],
  )
)
#v(0.5em)
#grid(
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Pluviométrie – Stations Météo France],
 0.7em,
    text(size: 0.75em)[Données stations pluviométriques Météo France NC],
 0.5em,
