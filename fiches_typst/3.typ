...
#grid(
  ...
  box(
    ...
    radius: 999pt,
    inset: (x: 12pt, y: 8pt),
    text(size: 0.9em, weight: "bold", fill: white)[Fiche n°3]
  ),
)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Comparer la capacité de stockage associée aux captages afin d’identifier les systèmes les plus résilients face aux aléas.],
      ),
      stack(dir: ttb, spacing: 0.1em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Faible stockage = forte criticité (manque résilience), fort stockage = faible criticité],
      ),
    )
  ),
  box(
