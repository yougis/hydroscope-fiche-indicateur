...
#v(0.3em)
#text(size: 0.85em, fill: rgb("#666"))[Fiche n°37]
#v(0.5em)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Comparer les captages selon les volumes prélevés afin d’évaluer l’intensité de la pression quantitative.],
      ),
      stack(dir: ttb, spacing: 0.1em,
