...
#grid(
  ...
  box(
    ...
    radius: 999pt,
    inset: (x: 12pt, y: 8pt),
    text(size: 0.9em, weight: "bold", fill: white)[Fiche n°501]
  ),
)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Comparer les bassins versants selon les apports en eau afin de contextualiser la disponibilité de la ressource.],
      ),
      stack(dir: ttb, spacing: 0.1em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Faible pluie = forte criticité],
      ),
    )
  ),
  box(
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.95em, weight: "bold")[Pluviométrie – Stations Météo France],
    text(size: 0.85em)[#text(weight: "bold")[Origine :] Météo France],
    ...
    link("https://georep-dtsi-sgt.opendata.arcgis.com/items/d1636f919647426f88c40548b948d790")[#text(size: 0.85em, fill: brand)[Accéder à la ressource]],
    text(size: 0.85em, style: "italic")[Données stations pluviométriques Météo France NC],
  )
)
#v(0.5em)
#pagebreak()
