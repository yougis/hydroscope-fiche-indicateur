...
#grid(
  ...
  [
    #box(
      ...
      stroke: 1.2pt + brand,
      [
        #text(size: 0.85em, weight: "bold", fill: brand)[FICHE 14 <ind-14>]
      ]
    )
  ]
)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Nombre \/ présence d'espèces rares ou micro\-endémisme],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Mesurer la richesse spécifique menacée dépendante de la ressource en eau.],
    0.5em,
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[Calcul du nombre d’espèce menacé par unité spatiale régulière puis agrégation au bassin versant.],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
