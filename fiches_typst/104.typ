...
#grid(
  ...
  [
    #text(size: 1.6em, weight: "bold", fill: brand)[Forêt sèche]
  ],
  [
    #box(
      fill: rgb("#f1f5f9"),
...
#stack(dir: ltr, spacing: 0.6em,
  ...
  box(
    ...
    inset: (x: 6pt, y: 4pt),
    radius: 3pt,
    text(size: 0.75em, weight: "medium", fill: rgb("#475569"))[Richesse biologique et rareté]
  )
)
#v(0.6em)
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Superficie des intersections des patchs de forêt sèche],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Comparer les bassins versants AEP entre eux par rapport à leur taux de couverture par des patch de forêt sèche.],
    0.5em,
