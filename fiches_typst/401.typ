...
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Type de sol et de roche. Propriété des sols correspondant \(infiltrant \/ intermédiaire \/ ruisselant\)],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Comparer les bassins versants selon les propriétés des sols afin de qualifier leur comportement hydrologique.],
    0.5em,
...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Contours, surfaces, points et arcs structuraux géologiques],
    0.5em,
