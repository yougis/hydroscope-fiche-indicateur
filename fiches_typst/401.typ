...
#grid(
  ...
  [
    #box(
      ...
      stroke: 1.2pt + brand,
      [
        #text(size: 0.85em, weight: "bold", fill: brand)[FICHE 35 <ind-35>]
      ]
    )
  ]
)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Répartition des surfaces géologiques définissant les propriétés des sols \(infiltrant, intermédiaire ou ruisselant\). L'indicateur est basé sur la \"Géologie au 1\/200 000e\" de la DIMENC et du BRGM décrivant les formations rocheuses et arcs structuraux.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur les propriétés géologiques des sols afin de caractériser leur comportement hydrologique.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[Regroupement des classes géologiques en catégories simplifiées.],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
...
#box(
 ...
 0.7em,
      text(size: 0.71em)[La Géologie présente un risque élevé de redondance avec la vulnérabilité intrinsèque des eaux souterraines , ce dernier étant calculé à partir de données hydrologiques et géologiques.],
    ),
  )
)
#v(0.7em)
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Géologie au 1\/200 000e – DIMENC\/SGNC\-BRGM 1981],
 0.7em,
    text(size: 0.75em)[Contours, surfaces, points et arcs structuraux géologiques],
 0.5em,
 ...
 0.5em,
    text(size: 0.75em)[#link("https:\/\/georep\-dtsi\-sgt.opendata.arcgis.com\/documents\/cbb272c52a0a4725a154d1be059bee17")[🔗 Accès à la ressource]],
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Contraintes :] Risque de redondance avec d’autres indicateurs et nécessité de simplification.],
 0.5em,
 0.7em,
  )
)
