...
#grid(
  ...
  [
    #text(size: 1.6em, weight: "bold", fill: brand)[Espèces rares et menacées dont forêt sèche]
  ],
  [
    #box(
      fill: rgb("#f1f5f9"),
      ...
      stroke: 1.2pt + brand,
      [
        #text(size: 0.85em, weight: "bold", fill: brand)[FICHE 18 <ind-18>]
      ]
    )
  ]
)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure la superficie des intersections des patchs de forêt sèche additionnée aux zones potentielles de présence d’espèces rares et menacées. L'indicateur fusionne les données \"Espèces rares\" d'Endemia et les \"Indices de vulnérabilité de la forêt sèche\" du CEN pour cartographier les écosystèmes fragiles.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur la présence d’écosystèmes sensibles afin de caractériser les enjeux écologiques du territoire.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer le rôle des milieux sensibles dans la protection de la ressource en eau, une forte présence réduisant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[Présence de forêt sèche  = criticité faible bien que enjeu fort \(à confirmer\)],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
        text(size: 0.75em, weight: "bold")[Sens de l'indicateur],
        text(size: 0.71em)[Négatif \(absence = critique\) \? #h(0.2em) #text(fill: rgb("#c62828"), size: 0.95em)[↓]],
      ),
    )
  ),
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Espèces rares et menacées \(nom à vérifier\)],
 0.7em,
    text(size: 0.75em)[Couche espèces menacées non publiée sur GéoRep – consulter directement ENDEMIA],
 0.5em,
 ...
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Contraintes :] Données ponctuelles et incomplètes selon les groupes taxonomiques.],
 0.5em,
 0.7em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Forêt sèche – Indices de vulnérabilité],
 0.7em,
 ...
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Disponibilité :] Disponible],
 0.5em,
    text(size: 0.75em)[#link("https:\/\/georep\-dtsi\-sgt.opendata.arcgis.com\/maps\/b9304b72009f45e6aa4fc2fab702e98b")[🔗 Accès à la ressource]],
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Contraintes :] Cartographie partielle selon les provinces.],
 0.5em,
 0.7em,
  )
)
