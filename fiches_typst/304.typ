...
#v(0.3em)
#text(size: 0.85em, fill: rgb("#666"))[Fiche n°28]
#v(0.5em)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Comparer les bassins versants selon la densité d’habitat afin d’affiner l’analyse des pressions humaines.],
      ),
      stack(dir: ttb, spacing: 0.1em,
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    text(size: 0.71em, style: "italic")[Exploiter les données de typologie des logements ISEE non publiées sur GéoRep – croiser avec la couche zones bâties de la BDTOPO],
  )
)
#v(0.5em)
#pagebreak()
