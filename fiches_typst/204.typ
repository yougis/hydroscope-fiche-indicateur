...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Estimation de la présence de cerfs et de cochons basée sur le comptage des mâchoires. Cet indicateur se base sur les données de l'ANCB, utilisant les bilans régionalisés par commune et les résultats des campagnes de régularisation de la faune.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur la présence d’espèces envahissantes afin de caractériser les perturbations écologiques.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer la pression écologique exercée sur la ressource en eau.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
