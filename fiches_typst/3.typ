...
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Quantité d’eau pouvant être stockée pour faire face aux besoins.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Comparer la capacité de stockage associée aux captages afin d’identifier les systèmes les plus résilients face aux aléas.],
    0.5em,
