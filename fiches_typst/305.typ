...
#stack(dir: ltr, spacing: 0.6em,
  ...
  box(fill: rgb("#f1f5f9"), stroke: 0.5pt + rgb("#cbd5e1"),
    inset: (x: 6pt, y: 4pt), radius: 3pt,
    text(size: 0.75em, fill: rgb("#475569"))[Infrastructures et risques de dégradation des eaux]
  ),
)
#v(0.6em)
#block(
...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Base de données voies du territoire NC – ouvrages franchissant l'hydrographie],
    0.5em,
    ...
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Base de données de la DAVAR identifiant les franchissements sur le réseau hydrographique],
    0.5em,
