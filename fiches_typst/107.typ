...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure la superficie des intersections avec des zones agricoles par type, incluant les terres arables, agropastorales ou la sylviculture. L'indicateur utilise le Mode d'Occupation du Sol \(MOS 2014\) de l'OEIL et du Gouvernement pour décrire les classes d'emprise humaine.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur l’emprise agricole du territoire afin de caractériser les usages du sol.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer les pressions diffuses exercées sur la ressource en eau, une forte emprise agricole augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[Forte surface agricole = pression potentielle élevée],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
