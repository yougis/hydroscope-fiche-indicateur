...
#grid(
  ...
  [#box(fill: rgb("#f1f5f9"), inset: (x: 10pt, y: 6pt), radius: 4pt,
    stroke: 1.2pt + brand,
    [#text(size: 0.85em, weight: "bold", fill: brand)[FICHE 22 <ind-22>]]
  )],
)
#v(0.5em)
...
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Zones exposées aux glissements de terrain.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Comparer les bassins versants selon leur instabilité afin d’identifier les zones à risque pour la ressource.],
    0.5em,
...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Compilation des cartographies d'aléa mouvement de terrain communal à l'échelle 1:25 000ème.],
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Aléa \(très faible, faible, modéré, élevé\)],
    0.5em,
