...
#grid(
  ...
  [
    #box(
      ...
      stroke: 1.2pt + brand,
      [
        #text(size: 0.85em, weight: "bold", fill: brand)[FICHE 17 <ind-17>]
      ]
    )
  ]
)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure la superficie des intersections avec les zones d'intérêt biologique et de biodiversité spécifique. Cet indicateur est issu de la ressource \"Zones clés de biodiversité\" du CEN, s'appuyant sur les standards internationaux de l'UICN pour localiser les zones d'intérêt majeur.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur la présence de zones à forte valeur écologique reconnues internationalement \(KBA\/ZICO\) afin de caractériser les enjeux de biodiversité et les opportunités de financement associées.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer le rôle de ces zones dans la préservation de la ressource en eau et dans l’accès à des dispositifs de financement environnementaux, une forte présence pouvant réduire la criticité écologique tout en augmentant l’intérêt stratégique du bassin versant.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Zones clés de biodiversité \(KBA – Key Biodiversity Areas\)],
 0.7em,
    text(size: 0.75em)[Standards UICN],
 0.5em,
 ...
 0.5em,
    text(size: 0.75em)[#link("https:\/\/georep\-dtsi\-sgt.opendata.arcgis.com\/maps\/934b1cad2b9045d8ac2c4d7b0a524f2e\/about")[🔗 Accès à la ressource]],
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Contraintes :] Données issues de bases internationales, à vérifier pour la Nouvelle\-Calédonie.],
 0.5em,
 0.7em,
  )
)
