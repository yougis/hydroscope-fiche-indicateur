...
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Nombre de prélèvements d’eau autorisés.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Comparer les captages selon le nombre de prélèvements afin d’évaluer la pression d’usage.],
    0.5em,
