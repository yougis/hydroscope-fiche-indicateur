...
#stack(dir: ltr, spacing: 0.6em,
  ...
  box(fill: rgb("#f1f5f9"), stroke: 0.5pt + rgb("#cbd5e1"),
    inset: (x: 6pt, y: 4pt), radius: 3pt,
    text(size: 0.75em, fill: rgb("#475569"))[Robustesse et résilience technique]
  ),
)
#v(0.6em)
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Quantité d’eau que la source peut fournir \(référence de période sèche\).],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Comparer la capacité des captages à fournir de l’eau en période contrainte \(sécheresse, inondation, glissement de terrain\) afin d’identifier les ressources les plus robustes ou les plus limitées.],
    0.5em,
...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Métadonnées stations de jaugeage et limnimètres DAVAR],
    0.5em,
