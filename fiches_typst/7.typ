...
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Présence ou non d’une autorisation officielle.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Comparer les captages selon leur niveau de conformité réglementaire afin d’identifier les situations à risque.],
    0.5em,
...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[AODPE],
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Données administratives DAVAR – contacter DAVAR],
    0.5em,
