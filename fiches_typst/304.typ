...
#grid(
  ...
  box(
    ...
    radius: 999pt,
    inset: (x: 12pt, y: 8pt),
    text(size: 0.9em, weight: "bold", fill: white)[Fiche n°304]
  ),
)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Comparer les bassins versants selon la densité d’habitat afin d’affiner l’analyse des pressions humaines.],
      ),
      stack(dir: ttb, spacing: 0.1em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Densité humaine = pression accrue],
      ),
    )
  ),
  box(
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.95em, weight: "bold")[Typologie de l’habitat],
    text(size: 0.85em)[#text(weight: "bold")[Origine :] ISEE],
    text(size: 0.85em)[#text(weight: "bold")[Distributeur :] ISEE],
    text(size: 0.85em)[#text(weight: "bold")[Couverture spatiale :] Nouvelle-calédonie],
    text(size: 0.85em)[#text(weight: "bold")[Actualisation :] 4 ans],
    text(size: 0.85em)[#text(weight: "bold")[Disponibilité :] Disponible],
    text(size: 0.85em, style: "italic")[Exploiter les données de typologie des logements ISEE non publiées sur GéoRep – croiser avec la couche zones bâties de la BDTOPO],
  )
)
#v(0.5em)
#pagebreak()
