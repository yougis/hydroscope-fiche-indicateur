...
#grid(
  ...
  box(
    ...
    radius: 999pt,
    inset: (x: 12pt, y: 8pt),
    text(size: 0.9em, weight: "bold", fill: white)[Fiche n°200]
  ),
)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.3em,
    ...
    text(size: 0.9em)[Permet une réaction rapide face aux chocs brutaux impactant le bassin versant.],
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Comparer les bassins versants selon leur historique d’incendies afin d’identifier les milieux les perturbés.],
      ),
      stack(dir: ttb, spacing: 0.1em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Forte surface brûlée = forte pression → criticité élevée],
      ),
    )
  ),
  box(
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.95em, weight: "bold")[Zones potentiellement brulées (VIIRS)],
    text(size: 0.85em)[#text(weight: "bold")[Origine :] OEIL],
    text(size: 0.85em)[#text(weight: "bold")[Distributeur :] OEIL],
    text(size: 0.85em)[#text(weight: "bold")[Couverture spatiale :] Nouvelle-calédonie],
    text(size: 0.85em)[#text(weight: "bold")[Actualisation :] Tous les jours],
    text(size: 0.85em)[#text(weight: "bold")[Disponibilité :] Disponible],
    link("https://geoportail.oeil.nc/geoportal/catalog/search/resource/details.page?uuid=%7B5D28AFE1-541C-4102-84F0-6959F769FA78%7D")[#text(size: 0.85em, fill: brand)[Accéder à la ressource]],
    text(size: 0.85em, style: "italic")[Surfaces potentiellement brûlées VIIRS depuis 2012. Il n’existe pas de source officielle qui fusionne les 2 capteurs VIIRS (SUOMI et JPSS)],
  )
)
#v(0.5em)
#pagebreak()
