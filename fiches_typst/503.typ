...
#text(size: 1.6em, weight: "bold", fill: brand)[AODPE nombre]
#v(0.3em)
#text(size: 0.85em, fill: rgb("#666"))[Fiche n°36]
#v(0.5em)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.3em,
    ...
    text(size: 0.75em)[Relève du pilotage : déclenche les restrictions ou les limitations de nouvelles autorisations.],
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Comparer les captages selon le nombre de prélèvements afin d’évaluer la pression d’usage.],
      ),
      stack(dir: ttb, spacing: 0.1em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.71em)[Plus de prélèvements = pression ressource],
      ),
    )
  ),
  box(
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    ...
    text(size: 0.71em, style: "italic")[Données administratives DAVAR – contacter DAVAR],
  )
)
#v(0.5em)
#pagebreak()
