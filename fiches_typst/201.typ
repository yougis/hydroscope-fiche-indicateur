...
#grid(
  ...
  [#box(fill: rgb("#f1f5f9"), inset: (x: 10pt, y: 6pt), radius: 4pt,
    stroke: 1.2pt + brand,
    [#text(size: 0.85em, weight: "bold", fill: brand)[FICHE 20 <ind-20>]]
  )],
)
#v(0.5em)
...
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Surface des zones où le sol est abîmé ou fragile.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Comparer les bassins versants selon leur sensibilité à l’érosion afin d’identifier les ressources exposées à des dégradations du milieu.],
    0.5em,
...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Cartographie des formes érosives en Province Sud],
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Érosion identifié et caractérisé uniquement sur la province Sud par imagerie satellite très haute résolution 2018\/2019],
    0.5em,
