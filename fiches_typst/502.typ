...
#stack(dir: ltr, spacing: 0.6em,
  ...
  box(
    ...
    inset: (x: 6pt, y: 4pt),
    radius: 3pt,
    text(size: 0.75em, weight: "medium", fill: rgb("#475569"))[Apports naturels]
  )
)
#v(0.6em)
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Suivi piézométrique des eaux souterraines],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Suivre l'évolution du niveau des nappes phréatiques pour détecter les tensions quantitatives.],
    0.5em,
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[Agrégation des données piézométriques par bassin versant ou maille.],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
  ...
  stack(dir: ttb, spacing: 0pt,
   block(breakable: true,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        v(0.4em),
        text(size: 0.72em)[#text(fill: rgb("#475569"), weight: "medium")[Unité :] m NGF],
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Base de données du sous\-sol de NC \(BDSSNC\) – forages et hydrogéologie],
 0.7em,
    text(size: 0.75em)[Informations brutes géologiques et techniques des ouvrages souterrains – DIMENC\/SGNC],
 0.5em,
 ...
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Actualisation :] Tous les mois],
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Type de source :] inconnu],
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Disponibilité :] Disponible],
 0.5em,
    text(size: 0.75em)[#link("https:\/\/georep.nc\/node\/1323")[🔗 Accès à la ressource]],
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Contraintes :] Croisement de sources nécessaire, avec incertitudes sur la précision spatiale.],
 0.5em,
 0.7em,
  )
)
