...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Bilan Besoin Ressource (nom à vérifier)],
 0.7em,
    text(size: 0.75em)[Bilan DAVAR diffusion interne – contacter DAVAR],
 0.5em,
