...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure la superficie de terrain sans végétation intersectant l'aire d'alimentation, en excluant les zones d'exploitations minières. La donnée utilise le MOS 2014 \(OEIL\/GOUV\) ou le flux Dynamic World pour identifier les surfaces minérales ou dévégétalisées.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur la présence de surfaces dévégétalisées afin de caractériser la dégradation du milieu.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer les transferts de polluants et sédiments vers la ressource en eau, une forte présence augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
