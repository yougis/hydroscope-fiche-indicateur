...
#grid(
  ...
  [
    #box(
      ...
      stroke: 1.2pt + brand,
      [
        #text(size: 0.85em, weight: "bold", fill: brand)[FICHE 31 <ind-31>]
      ]
    )
  ]
)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Identifie la surface des zones où le sol est abîmé ou fragile. L'indicateur s'appuie sur la \"Cartographie des formes érosives\" de l'OEIL décrivant les zones de sols dégradés identifiées par imagerie très haute résolution \(Province Sud\).],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur les zones érodées afin de caractériser la dégradation des sols.],
  )
)
#v(0.5em)
#grid(
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Cartographie des formes érosives en Province Sud],
 0.7em,
    text(size: 0.75em)[Érosion identifié et caractérisé uniquement sur la province Sud par imagerie satellite très haute résolution 2018\/2019],
 0.5em,
 ...
 0.5em,
    text(size: 0.75em)[#link("https:\/\/geoportail.oeil.nc\/cartenvironnement\/\?mapresources=FORMES\_EROSIVES\_2018")[🔗 Accès à la ressource]],
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Contraintes :] Données non homogènes spatialement, limitant la comparabilité à l’échelle du territoire.],
 0.5em,
 0.7em,
  )
)
