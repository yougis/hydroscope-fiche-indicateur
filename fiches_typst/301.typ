...
#grid(
  ...
  [
    #text(size: 1.6em, weight: "bold", fill: brand)[Zone d’exploitation minière]
  ],
  [
    #box(
      fill: rgb("#f1f5f9"),
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure la surface occupée par les activités minières, définie par les autorisations d'exploiter ou estimée via le MOS 2014. La donnée est issue de la ressource \"Exploitation minière\" de la DIMENC localisant les centres miniers et usines métallurgiques actifs.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur l’emprise minière afin de caractériser les activités extractives.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer les pressions fortes sur la ressource en eau, une emprise élevée augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
...
#block(breakable: true,
 ...
 0.5em,
 0.7em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Exploitation minière en Nouvelle\-Calédonie : centres miniers et usines métallurgiques],
 0.7em,
    text(size: 0.75em)[Centre minier et usine métallurgique \(peut être fusionner avec les ICPE aussi \?\)],
 0.5em,
