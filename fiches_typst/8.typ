...
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer la vulnérabilité de la ressource en eau face aux pressions extérieures, une absence de protection augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
