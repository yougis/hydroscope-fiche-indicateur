...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Dénombre les sites d'Installations Classées pour la Protection de l'Environnement, incluant les sites industriels, agricoles ou les stations de traitement. L'indicateur compile les bases ICPE de la DIMENC et des provinces Sud, Nord et Îles Loyauté.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur la présence d’activités à risque afin de caractériser les sources potentielles de pollution.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer les pressions industrielles sur la ressource en eau, une forte densité augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
