...
#grid(
  ...
  [
    #text(size: 1.6em, weight: "bold", fill: brand)[Nombre de prélèvement AODPE]
  ],
  [
    #box(
      fill: rgb("#f1f5f9"),
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Dénombre les points de prélèvements d’eau officiellement autorisés situés en amont de la ressource. Cet indicateur utilise la base \"AODPE\" de la DAVAR centralisant les données administratives des autorisations de prélèvement.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur le nombre de prélèvements autorisés afin de caractériser les usages.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[Comptage des prélèvements associés à chaque captage.],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[C'est la présence qui est positive, l'absence d'autorisation AODPE est négative],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
