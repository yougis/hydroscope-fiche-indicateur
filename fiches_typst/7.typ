...
#grid(
  ...
  [
    #text(size: 1.6em, weight: "bold", fill: brand)[Statut AODPE]
  ],
  [
    #box(
      fill: rgb("#f1f5f9"),
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Établit le statut de l'autorisation de prélèvement d'eau de la ressource et les informations associées, comme le numéro d'arrêté et le volume autorisé. Cet indicateur de conformité s'appuie sur la base \"AODPE\" de la DAVAR, qui centralise les données administratives relatives aux autorisations.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur le statut réglementaire du prélèvement d’eau afin de caractériser la conformité administrative du captage.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer les risques réglementaires liés à la ressource en eau, une absence d’autorisation augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[Absence d’autorisation = criticité forte \(non conformité\)],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
        text(size: 0.75em, weight: "bold")[Sens de l'indicateur],
        text(size: 0.71em)[Positif \(non conforme = critique\) #h(0.2em) #text(fill: rgb("#2e7d32"), size: 0.95em)[↑]],
      ),
    )
  ),
