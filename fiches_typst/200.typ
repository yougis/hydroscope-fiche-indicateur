...
#grid(
  ...
  [
    #box(
      ...
      stroke: 1.2pt + brand,
      [
        #text(size: 0.85em, weight: "bold", fill: brand)[FICHE 30 <ind-30>]
      ]
    )
  ]
)
...
#stack(dir: ltr, spacing: 0.6em,
  ...
  box(
    ...
    inset: (x: 6pt, y: 4pt),
    radius: 3pt,
    text(size: 0.75em, weight: "medium", fill: rgb("#475569"))[Perturbations environnementales]
  )
)
#v(0.6em)
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure la surface totale touchée par les incendies ces dernières années. Cet indicateur exploite la ressource \"Zones potentiellement brûlées\" de l'OEIL, issue des détections quotidiennes des capteurs satellitaires VIIRS depuis 2012.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur l’historique des incendies afin de caractériser les perturbations du milieu.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer l’impact des incendies sur la dégradation de la ressource en eau, une forte surface brûlée augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : Zones potentiellement brulées \(VIIRS\)],
 0.7em,
    text(size: 0.75em)[Surfaces potentiellement brûlées VIIRS depuis 2012. Il n’existe pas de source officielle qui fusionne les 2 capteurs VIIRS \(SUOMI et JPSS\)],
 0.5em,
 ...
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Contraintes :] Nécessité de faire une fusion des capteurs selon une stratégie cohérente  à partir des différents capteurs],
 0.5em,
 0.7em,
  )
)
