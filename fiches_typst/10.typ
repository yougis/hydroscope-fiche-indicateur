...
#grid(
  ...
  [#box(fill: rgb("#f1f5f9"), inset: (x: 10pt, y: 6pt), radius: 4pt,
    stroke: 1.2pt + brand,
    [#text(size: 0.85em, weight: "bold", fill: brand)[FICHE 10 <ind-10>]]
  )],
)
#v(0.5em)
...
#block(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Statut d’utilisation \(actif, secours, abandonné\).],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Distinguer les captages selon leur statut afin de contextualiser leur valeur dans la comparaison.],
    0.5em,
