...
#text(size: 1.6em, weight: "bold", fill: brand)[Glissement terrain]
#v(0.4em)
#grid(
  columns: (1fr, auto),
  column-gutter: 10pt,
  ...
  box(
    ...
    radius: 999pt,
    inset: (x: 12pt, y: 8pt),
    text(size: 0.9em, weight: "bold", fill: white)[Fiche n°203]
  ),
)
  ...
  box(
    ...
    stack(dir: ttb, spacing: 0.35em,
      ...
      stack(dir: ttb, spacing: 0.1em,
        ...
        text(size: 0.85em)[Comparer les bassins versants selon leur instabilité afin d’identifier les zones à risque pour la ressource.],
      ),
      stack(dir: ttb, spacing: 0.1em,
...
#fiche_alert_box[
  #stack(dir: ttb, spacing: 0.3em,
    ...
    stack(dir: ttb, spacing: 0.1em,
      text(size: 0.85em, weight: "bold")[Incohérence (R5)],
      text(size: 0.85em)[Le Glissement de terrain est classé en Pression mais fait débat pour un déplacement vers la famille Vulnérabilité (aléa lié à la nature du terrain) \[7\].],
    ),
  )
]
#v(0.7em)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.95em, weight: "bold")[Compilation des cartographies d'aléa mouvement de terrain communal à l'échelle 1:25 000ème.],
    text(size: 0.85em)[#text(weight: "bold")[Origine :] DIMENC],
    text(size: 0.85em)[#text(weight: "bold")[Distributeur :] GEOREP],
    text(size: 0.85em)[#text(weight: "bold")[Couverture spatiale :] 15 communes],
    text(size: 0.85em)[#text(weight: "bold")[Actualisation :] inconnu],
    text(size: 0.85em)[#text(weight: "bold")[Disponibilité :] Disponible],
    link("https://dtsi-sgt.maps.arcgis.com/home/item.html?id=c472c49f798046b9b2c716c83523c324")[#text(size: 0.85em, fill: brand)[Accéder à la ressource]],
    text(size: 0.85em, style: "italic")[Aléa (très faible, faible, modéré, élevé)],
  )
)
#v(0.5em)
#pagebreak()
