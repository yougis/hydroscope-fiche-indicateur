...
#grid(
  ...
  [
    #text(size: 1.6em, weight: "bold", fill: brand)[Type ouvrage]
  ],
  [
    #box(
      fill: rgb("#f1f5f9"),
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Établit le type de ressource en eaux en fonction de l'ouvrage, tel que le captage superficiel, le forage ou la tranchée drainante. L'indicateur s'appuie sur la base \"Captages d'eau\" de la DAVAR répertoriant les caractéristiques techniques des ouvrages de prélèvement.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur le type d’ouvrage de captage afin de caractériser ses caractéristiques techniques.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer la vulnérabilité intrinsèque de la ressource en eau, certains types d’ouvrages augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        text(size: 0.71em)[Captage superficiel = plus vulnérable → criticité forte],
      ),
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
  ...
  stack(dir: ttb, spacing: 0pt,
   block(breakable: true,
      ...
      stack(dir: ttb, spacing: 0.4em,
        ...
        v(0.4em),
        text(size: 0.72em)[#text(fill: rgb("#475569"), weight: "medium")[Unité :] Classe \(forage \/ captage \/ tranchée drainante\)],
