...
#stack(dir: ltr, spacing: 0.6em,
  ...
  box(fill: rgb("#f1f5f9"), stroke: 0.5pt + rgb("#cbd5e1"),
    inset: (x: 6pt, y: 4pt), radius: 3pt,
    text(size: 0.75em, fill: rgb("#475569"))[Niveau d'artificialisation et densité]
  ),
)
#v(0.6em)
#block(
...
#block(breakable: true, width: 100%, fill: fiche_bg,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Typologie de l’habitat],
    0.7em,
    text(size: 0.75em)[#text(weight: "bold")[Description :] Exploiter les données de typologie des logements ISEE non publiées sur GéoRep – croiser avec la couche zones bâties de la BDTOPO],
    0.5em,
