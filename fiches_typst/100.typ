...
#grid(
  ...
  [
    #box(
      ...
      stroke: 1.2pt + brand,
      [
        #text(size: 0.85em, weight: "bold", fill: brand)[FICHE 15 <ind-15>]
      ]
    )
  ]
)
...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure la superficie des intersections avec les zones inscrites au patrimoine mondial de l'UNESCO. L'indicateur exploite la couche du CEN décrivant les zones terrestres tampons qui alimentent les zones marines classées au patrimoine mondial.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur la présence de zones inscrites au patrimoine mondial de l’UNESCO dans le bassin versant afin de caractériser les enjeux environnementaux, patrimoniaux et les opportunités de valorisation et de financement associées.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer l’effet de la présence de zones UNESCO sur la ressource en eau en termes de préservation du milieu et de potentiel d’accès à des financements internationaux, une forte couverture pouvant réduire la criticité environnementale tout en augmentant l’intérêt stratégique du captage.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
...
#block(breakable: true,
  ...
  stack(dir: ttb, spacing: 0.25em,
    text(size: 0.8em, weight: "bold")[Nom de la base de donnée : zones inscrites au patrimoine mondial de l'UNESCO],
 0.7em,
    text(size: 0.75em)[Zone terrestres, qui représentent les bassins versants débouchant dans les zones inscrites dites \"zones de bien\"],
 0.5em,
