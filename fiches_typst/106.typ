...
#stack(dir: ltr, spacing: 0.6em,
  ...
  box(
    ...
    inset: (x: 6pt, y: 4pt),
    radius: 3pt,
    text(size: 0.75em, weight: "medium", fill: rgb("#475569"))[Zone naturelle]
  )
)
#v(0.6em)
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Mesure la superficie des intersections avec des zones de couverture forestière non perturbée et dégradée. La donnée est basée sur la \"Cartographie des surfaces forestières\" \(TMF\) décrivant l'étendue de la forêt tropicale humide sans distinction des classes dynamiques.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur la couverture forestière afin de caractériser le niveau de protection naturelle.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer le rôle protecteur de la forêt sur la ressource en eau, une faible couverture augmentant la criticité.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
