...
#box(
  ...
  stack(dir: ttb, spacing: 0.4em,
    text(size: 0.73em, style: "italic", fill: rgb("#334155"))[Identifie les zones exposées aux glissements de terrain par la répartition des surfaces d'aléa. L'indicateur mobilise la \"Compilation des cartographies d'aléa mouvement de terrain\" de la DIMENC décrivant les niveaux d'aléa de très faible à élevé.],
    1em,
    text(size: 0.71em, weight: "bold", fill: rgb("#1a365d"))[Objectif :],
    text(size: 0.71em, fill: rgb("#1a202c"))[Informer sur les zones à risque de glissement afin de caractériser l’instabilité du terrain.],
  )
)
#v(0.5em)
#grid(
  ...
  box(
    ...
    text(size: 0.71em, fill: rgb("#1a202c"))[Évaluer les perturbations potentielles de la ressource en eau liées à l’instabilité des sols.],
      0.7em,
      stack(dir: ttb, spacing: 0.4em,
...
#block(breakable: true,
 ...
 0.5em,
    text(size: 0.75em)[#text(weight: "bold")[Couverture spatiale :] 15 communes],
 0.5em,
